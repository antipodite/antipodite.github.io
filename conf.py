...
BLOG_AUTHOR = "Isaac Stead"  # (translatable)
BLOG_TITLE = "Wonders of the Invisible World"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://antipodite.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://antipodite.github.io/"
BLOG_EMAIL = "isaac_stead@eva.mpg.de"
BLOG_DESCRIPTION = "Isaac's personal website"  # (translatable)
